...
#include "open_space_msg/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _OpenSpace_type_support_symbol_names_t _OpenSpace_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, open_space_msg, msg, OpenSpace)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, open_space_msg, msg, OpenSpace)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_open_space_msg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, open_space_msg, msg, OpenSpace)() {
  return &::open_space_msg::msg::rosidl_typesupport_c::OpenSpace_message_type_support_handle;
}
