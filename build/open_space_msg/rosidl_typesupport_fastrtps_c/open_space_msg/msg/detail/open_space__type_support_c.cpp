...
#include "open_space_msg/msg/detail/open_space__rosidl_typesupport_fastrtps_c.h"
...
#include "open_space_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _OpenSpace__ros_msg_type = open_space_msg__msg__OpenSpace;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_open_space_msg
size_t get_serialized_size_open_space_msg__msg__OpenSpace(
  const void * untyped_ros_message,
...
static uint32_t _OpenSpace__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_open_space_msg__msg__OpenSpace(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_open_space_msg
size_t max_serialized_size_open_space_msg__msg__OpenSpace(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_open_space_msg__msg__OpenSpace(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, open_space_msg, msg, OpenSpace)() {
