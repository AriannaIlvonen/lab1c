...
bool open_space_msg__msg__open_space__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("open_space_msg.msg._open_space.OpenSpace", full_classname_dest, 40) == 0);
  }
  open_space_msg__msg__OpenSpace * ros_message = _ros_message;
  {  // angle
...
PyObject * open_space_msg__msg__open_space__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("open_space_msg.msg._open_space");
