...
#include <stddef.h>
#include "open_space_msg/msg/detail/open_space__rosidl_typesupport_introspection_c.h"
#include "open_space_msg/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  open_space_msg__msg__OpenSpace__init(message_memory);
}

void OpenSpace__rosidl_typesupport_introspection_c__OpenSpace_fini_function(void * message_memory)
{
  open_space_msg__msg__OpenSpace__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember OpenSpace__rosidl_typesupport_introspection_c__OpenSpace_message_member_array[2] = {
  {
    ...
    offsetof(open_space_msg__msg__OpenSpace, angle),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(open_space_msg__msg__OpenSpace, distance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers OpenSpace__rosidl_typesupport_introspection_c__OpenSpace_message_members = {
  "open_space_msg__msg",  // message namespace
  "OpenSpace",  // message name
  2,  // number of fields
  sizeof(open_space_msg__msg__OpenSpace),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_open_space_msg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, open_space_msg, msg, OpenSpace)() {
